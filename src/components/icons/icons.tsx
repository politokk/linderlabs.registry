...
import Airpods from "@untitled-ui/icons-react/build/esm/Airpods.js"
...
import BracketsEllipses from "@untitled-ui/icons-react/build/esm/BracketsEllipses.js"
...
import Disc01 from "@untitled-ui/icons-react/build/esm/Disc01.js"
...
import Headphones02 from "@untitled-ui/icons-react/build/esm/Headphones02.js"
...
import LifeBuoy01 from "@untitled-ui/icons-react/build/esm/LifeBuoy01.js"
...
import Minimize01 from "@untitled-ui/icons-react/build/esm/Minimize01.js"
...
const iconMap = {
  ...
  annotationAlert: {
    ...
    tooltip: "Annotation Alert",
  },
  annotationCheck: {
    category: "editors",
    icon: AnnotationCheck,
    tooltip: "Annotation Check",
  },
  annotationHeart: {
    category: "editors",
    icon: AnnotationHeart,
    tooltip: "Annotation Heart",
  },
  annotationInfo: {
    category: "editors",
    icon: AnnotationInfo,
  ...
  annotationPlus: {
    category: "editors",
    icon: AnnotationPlus,
    tooltip: "Annotation Plus",
  },
  annotationQuestion: {
    category: "editors",
    icon: AnnotationQuestion,
    tooltip: "Annotation Question",
  },
  annotationX: {
    category: "editors",
    icon: AnnotationX,
    tooltip: "Annotation X",
  },
  archive: { category: "files", icon: Archive, tooltip: "Archive" },
  arrowBlockDown: {
    category: "arrows",
    icon: ArrowBlockDown,
    tooltip: "Arrow Block Down",
  },
  arrowBlockLeft: {
    category: "arrows",
    icon: ArrowBlockLeft,
    tooltip: "Arrow Block Left",
  },
  arrowBlockRight: {
    category: "arrows",
    icon: ArrowBlockRight,
    tooltip: "Arrow Block Right",
  },
  arrowBlockUp: {
    category: "arrows",
    icon: ArrowBlockUp,
    tooltip: "Arrow Block Up",
  },
  arrowCircleBrokenDown: {
    category: "editors",
    icon: ArrowCircleBrokenDown,
    tooltip: "Arrow Circle Broken Down",
  },
  ...
  arrowCircleBrokenLeft: {
    ...
    tooltip: "Arrow Circle Broken Left",
  },
  arrowCircleBrokenRight: {
    category: "editors",
    icon: ArrowCircleBrokenRight,
    tooltip: "Arrow Circle Broken Right",
  },
  arrowCircleBrokenUp: {
    category: "editors",
    icon: ArrowCircleBrokenUp,
    tooltip: "Arrow Circle Broken Up",
  },
  ...
  arrowCircleDown: {
    ...
    tooltip: "Arrow Circle Down",
  },
  arrowCircleDownLeft: {
    category: "editors",
    icon: ArrowCircleDownLeft,
    tooltip: "Arrow Circle Down Left",
  },
  arrowCircleDownRight: {
    category: "editors",
    icon: ArrowCircleDownRight,
    tooltip: "Arrow Circle Down Right",
  },
  arrowCircleLeft: {
    category: "editors",
    icon: ArrowCircleLeft,
    tooltip: "Arrow Circle Left",
  },
  arrowCircleRight: {
    category: "editors",
    icon: ArrowCircleRight,
    tooltip: "Arrow Circle Right",
  },
  arrowCircleUp: {
    category: "editors",
    icon: ArrowCircleUp,
    tooltip: "Arrow Circle Up",
  },
  arrowCircleUpLeft: {
    category: "editors",
    icon: ArrowCircleUpLeft,
    tooltip: "Arrow Circle Up Left",
  },
  arrowCircleUpRight: {
    category: "editors",
    icon: ArrowCircleUpRight,
    tooltip: "Arrow Circle Up Right",
  },
  arrowDown: {
    category: "arrows",
  ...
  arrowDownLeft: {
    category: "arrows",
    icon: ArrowDownLeft,
    tooltip: "Arrow Down Left",
  },
  arrowDownRight: {
    category: "arrows",
    icon: ArrowDownRight,
    tooltip: "Arrow Down Right",
  },
  ...
  arrowNarrowDown: {
    ...
    tooltip: "Arrow Narrow Down",
  },
  arrowNarrowDownLeft: {
    category: "arrows",
    icon: ArrowNarrowDownLeft,
    tooltip: "Arrow Narrow Down Left",
  },
  arrowNarrowDownRight: {
    category: "arrows",
    icon: ArrowNarrowDownRight,
    tooltip: "Arrow Narrow Down Right",
  },
  arrowNarrowLeft: {
    category: "arrows",
    icon: ArrowNarrowLeft,
    tooltip: "Arrow Narrow Left",
  },
  arrowNarrowRight: {
    category: "arrows",
    icon: ArrowNarrowRight,
    tooltip: "Arrow Narrow Right",
  },
  arrowNarrowUp: {
    category: "arrows",
    icon: ArrowNarrowUp,
    tooltip: "Arrow Narrow Up",
  },
  arrowNarrowUpLeft: {
    category: "arrows",
    icon: ArrowNarrowUpLeft,
    tooltip: "Arrow Narrow Up Left",
  },
  arrowNarrowUpRight: {
    category: "editors",
    icon: ArrowNarrowUpRight,
    tooltip: "Arrow Narrow Up Right",
  },
  arrowRight: {
    category: "arrows",
    icon: ArrowRightIcon,
  ...
  arrowSquareDown: {
    ...
    tooltip: "Arrow Square Down",
  },
  arrowSquareDownLeft: {
    category: "arrows",
    icon: ArrowSquareDownLeft,
    tooltip: "Arrow Square Down Left",
  },
  arrowSquareDownRight: {
    category: "arrows",
    icon: ArrowSquareDownRight,
    tooltip: "Arrow Square Down Right",
  },
  arrowSquareLeft: {
    category: "arrows",
    icon: ArrowSquareLeft,
    tooltip: "Arrow Square Left",
  },
  arrowSquareRight: {
    category: "arrows",
    icon: ArrowSquareRight,
    tooltip: "Arrow Square Right",
  },
  arrowSquareUp: {
    category: "arrows",
    icon: ArrowSquareUp,
    tooltip: "Arrow Square Up",
  },
  arrowSquareUpLeft: {
    category: "arrows",
    icon: ArrowSquareUpLeft,
    tooltip: "Arrow Square Up Left",
  },
  arrowSquareUpRight: {
    category: "arrows",
    icon: ArrowSquareUpRight,
    tooltip: "Arrow Square Up Right",
  },
  arrowsTriangle: {
    category: "arrows",
    icon: ArrowsTriangle,
    tooltip: "Arrows Triangle",
  },
  ...
  arrowUpLeft: {
    category: "arrows",
    icon: ArrowUpLeft,
    tooltip: "Arrow Up Left",
  },
  arrowUpRight: {
    category: "arrows",
    icon: ArrowUpRight,
    tooltip: "Arrow Up Right",
  },
  ...
  barChart05: {
    category: "editors",
    icon: BarChart05,
    tooltip: "Bar Chart 05",
  },
  barChart06: {
    category: "editors",
    icon: BarChart06,
    tooltip: "Bar Chart 06",
  },
  barChart07: {
    category: "editors",
    icon: BarChart07,
    tooltip: "Bar Chart 07",
  },
  barChart08: {
    category: "editors",
    icon: BarChart08,
    tooltip: "Bar Chart 08",
  },
  barChart09: {
    category: "editors",
    icon: BarChart09,
    tooltip: "Bar Chart 09",
  },
  barChart10: {
    category: "editors",
    icon: BarChart10,
    tooltip: "Bar Chart 10",
  },
  barChart11: {
    category: "editors",
    icon: BarChart11,
    tooltip: "Bar Chart 11",
  },
  barChart12: {
    category: "editors",
    icon: BarChart12,
    tooltip: "Bar Chart 12",
  },
  barChartCircle01: {
    category: "charts",
    icon: BarChartCircle01,
    tooltip: "Bar Chart Circle 01",
  },
  barChartCircle02: {
    category: "charts",
    icon: BarChartCircle02,
    tooltip: "Bar Chart Circle 02",
  },
  barChartCircle03: {
    category: "charts",
    icon: BarChartCircle03,
    tooltip: "Bar Chart Circle 03",
  },
  barChartSquare01: {
    category: "charts",
    icon: BarChartSquare01,
    tooltip: "Bar Chart Square 01",
  },
  barChartSquare02: {
    category: "charts",
    icon: BarChartSquare02,
    tooltip: "Bar Chart Square 02",
  },
  barChartSquareDown: {
    category: "editors",
    icon: BarChartSquareDown,
    tooltip: "Bar Chart Square Down",
  },
  barChartSquareMinus: {
    category: "editors",
    icon: BarChartSquareMinus,
    tooltip: "Bar Chart Square Minus",
  },
  barChartSquarePlus: {
    category: "editors",
    icon: BarChartSquarePlus,
    tooltip: "Bar Chart Square Plus",
  },
  barChartSquareUp: {
    category: "editors",
    icon: BarChartSquareUp,
    tooltip: "Bar Chart Square Up",
  },
  barLineChart: {
    category: "charts",
    icon: BarLineChart,
    tooltip: "Bar Line Chart",
  },
  ...
  bookmarkCheck: {
    category: "editors",
    icon: BookmarkCheck,
    tooltip: "Bookmark Check",
  },
  bookmarkMinus: {
    category: "editors",
    icon: BookmarkMinus,
    tooltip: "Bookmark Minus",
  },
  ...
  BracketsEllipses: { category: "editors", icon: BracketsEllipses, tooltip: "BracketsEllipses" },
  buoy: { category: "general", icon: LifeBuoy01, tooltip: "Buoy" },
  ...
  chartBreakoutCircle: {
    ...
    tooltip: "Chart Breakout Circle",
  },
  chartBreakoutSquare: {
    category: "editors",
    icon: ChartBreakoutSquare,
    tooltip: "Chart Breakout Square",
  },
  ...
  chevronDown: {
    category: "arrows",
    icon: ChevronDownIcon,
    tooltip: "Chevron Down",
  },
  chevronDownDouble: {
    category: "arrows",
    icon: ChevronDownDouble,
    tooltip: "Chevron Down Double",
  },
  chevronLeft: {
    category: "arrows",
    icon: ChevronLeftIcon,
    tooltip: "Chevron Left",
  },
  chevronLeftDouble: {
    category: "arrows",
    icon: ChevronLeftDouble,
    tooltip: "Chevron Left Double",
  },
  chevronRight: {
    category: "arrows",
    icon: ChevronRightIcon,
    tooltip: "Chevron Right",
  },
  chevronRightDouble: {
    category: "editors",
    icon: ChevronRightDouble,
    tooltip: "Chevron Right Double",
  },
  ...
  chevronSelectorVertical: {
    ...
    tooltip: "Chevron Selector Vertical",
  },
  chevronsLeft: {
    category: "arrows",
    icon: ChevronsLeftIcon,
    tooltip: "Chevrons Left",
  },
  chevronsLeftRight: {
    category: "arrows",
    icon: ChevronsLeftRightIcon,
    tooltip: "Chevrons Left Right",
  },
  chevronsRight: {
    category: "arrows",
    icon: ChevronsRightIcon,
    tooltip: "Chevrons Right",
  },
  chevronsUpDown: {
    category: "arrows",
    icon: ChevronsUpDownIcon,
    tooltip: "Chevrons Up Down",
  },
  chevronUp: { category: "arrows", icon: ChevronUpIcon, tooltip: "Chevron Up" },
  chevronUpDouble: {
    category: "arrows",
    icon: ChevronUpDouble,
    tooltip: "Chevron Up Double",
  },
  ...
  component: { category: "general", icon: Component, tooltip: "Component" },
  ...
  downloadCloud01: {
    ...
    tooltip: "Download Cloud 01",
  },
  downloadCloud02: {
    category: "editors",
    icon: DownloadCloud02,
    tooltip: "Download Cloud 02",
  },
  dragHandle: {
    category: "general",
    icon: GripVertical,
  ...
  disc: { category: "general", icon: Disc01, tooltip: "Disc" },
  ...
  expand: { category: "editors", icon: Expand, tooltip: "Expand" },
  ...
  folderHeart: {
    category: "files",
    icon: FolderHeart,
    tooltip: "Folder Heart",
  },
  folderPlus: { category: "general", icon: FolderPlus, tooltip: "Folder Plus" },
  folderOpen: { category: "general", icon: FolderOpen, tooltip: "Folder Open" },
  font: { category: "editors", icon: Heading02, tooltip: "Font" },
  format: { category: "general", icon: LayoutTemplate, tooltip: "Format" },
  fullwidth: {
    category: "editors",
    icon: SpacingWidth02,
    tooltip: "Full Width",
  ...
  headphones02: { category: "general", icon: Headphones02, tooltip: "Headphones 02" },
  ...
  horizontalBarChart01: {
    ...
    tooltip: "Horizontal Bar Chart 01",
  },
  horizontalBarChart02: {
    category: "charts",
    icon: HorizontalBarChart02,
    tooltip: "Horizontal Bar Chart 02",
  },
  horizontalBarChart03: {
    category: "charts",
    icon: HorizontalBarChart03,
    tooltip: "Horizontal Bar Chart 03",
  },
  ...
  imageUpload: { category: "media", icon: UploadIcon, tooltip: "Image Upload" },
  ...
  layoutpaneltop: {
    category: "layout",
    icon: LayoutPanelTop,
    tooltip: "Layout Panel Top",
  },
  layoutright: {
    category: "editors",
    icon: FlexAlignRight,
    tooltip: "Layout Right",
  },
  LayoutTemplate: {
    category: "editors",
    icon: LayoutTemplate,
    tooltip: "Layout Template",
  },
  leftindent: {
    category: "editors",
    icon: LeftIndent01,
  ...
  lineChartDown01: {
    ...
    tooltip: "Line Chart Down 01",
  },
  lineChartDown02: {
    category: "charts",
    icon: LineChartDown02,
    tooltip: "Line Chart Down 02",
  },
  lineChartDown03: {
    category: "editors",
    icon: LineChartDown03,
    tooltip: "Line Chart Down 03",
  },
  lineChartDown04: {
    category: "editors",
    icon: LineChartDown04,
    tooltip: "Line Chart Down 04",
  },
  lineChartDown05: {
    category: "editors",
    icon: LineChartDown05,
    tooltip: "Line Chart Down 05",
  },
  lineChartUp01: {
    category: "editors",
    icon: LineChartUp01,
    tooltip: "Line Chart Up 01",
  },
  lineChartUp02: {
    category: "editors",
    icon: LineChartUp02,
    tooltip: "Line Chart Up 02",
  },
  lineChartUp03: {
    category: "editors",
    icon: LineChartUp03,
    tooltip: "Line Chart Up 03",
  },
  lineChartUp04: {
    category: "editors",
    icon: LineChartUp04,
    tooltip: "Line Chart Up 04",
  },
  lineChartUp05: {
    category: "editors",
    icon: LineChartUp05,
    tooltip: "Line Chart Up 05",
  },
  ...
  linkBroken02: {
    category: "editors",
    icon: LinkBroken02,
    tooltip: "Link Broken 02",
  },
  linkExternal01: {
    category: "editors",
    icon: LinkExternal01,
    tooltip: "Link External 01",
  },
  linkExternal02: {
    category: "editors",
    icon: LinkExternal02,
    tooltip: "Link External 02",
  },
  ...
  logoX: { category: "editors", icon: XIcon, tooltip: "Logo X" },
  lucideCornerDownLeft: {
    category: "editors",
    icon: CornerDownLeft,
    tooltip: "Lucide Corner Down Left",
  },
  lucideCornerUpLeft: {
    category: "editors",
    icon: CornerUpLeft,
    tooltip: "Lucide Corner Up Left",
  },
  ...
  messageAlertCircle: {
    ...
    tooltip: "Message Alert Circle",
  },
  messageAlertSquare: {
    category: "editors",
    icon: MessageAlertSquare,
    tooltip: "Message Alert Square",
  },
  messagebot: {
    category: "editors",
  ...
  messagebotoff: {
    category: "editors",
    icon: BotOff,
    tooltip: "Message Bot Off",
  },
  messageChatCircle: {
    category: "editors",
    icon: MessageChatCircle,
    tooltip: "Message Chat Circle",
  },
  messageChatSquare: {
    category: "editors",
    icon: MessageChatSquare,
    tooltip: "Message Chat Square",
  },
  messageCheckCircle: {
    category: "editors",
    icon: MessageCheckCircle,
    tooltip: "Message Check Circle",
  },
  messageCheckSquare: {
    category: "editors",
    icon: MessageCheckSquare,
    tooltip: "Message Check Square",
  },
  messageCircle01: {
    category: "editors",
    icon: MessageCircle01,
    tooltip: "Message Circle 01",
  },
  messageCircle02: {
    category: "editors",
    icon: MessageCircle02,
    tooltip: "Message Circle 02",
  },
  messageDotsCircle: {
    category: "editors",
    icon: MessageDotsCircle,
    tooltip: "Message Dots Circle",
  },
  messageDotsSquare: {
    category: "editors",
    icon: MessageDotsSquare,
    tooltip: "Message Dots Square",
  },
  messageHeartCircle: {
    category: "editors",
    icon: MessageHeartCircle,
    tooltip: "Message Heart Circle",
  },
  messageHeartSquare: {
    category: "editors",
    icon: MessageHeartSquare,
    tooltip: "Message Heart Square",
  },
  ...
  messagePlusCircle: {
    ...
    tooltip: "Message Plus Circle",
  },
  messagePlusSquare: {
    category: "editors",
    icon: MessagePlusSquare,
    tooltip: "Message Plus Square",
  },
  messageQuestionCircle: {
    category: "editors",
    icon: MessageQuestionCircle,
    tooltip: "Message Question Circle",
  },
  messageQuestionSquare: {
    category: "editors",
    icon: MessageQuestionSquare,
    tooltip: "Message Question Square",
  },
  messages: {
    category: "editors",
  ...
  messageSmileCircle: {
    ...
    tooltip: "Message Smile Circle",
  },
  messagesmilesquare: {
    category: "editors",
    icon: MessageSmileSquare,
    tooltip: "Message Smile Square",
  },
  messageSmileSquare: {
    category: "editors",
    icon: MessageSmileSquare,
  ...
  messageSquare01: {
    ...
    tooltip: "Message Square 01",
  },
  messageSquare02: {
    category: "editors",
    icon: MessageSquare02,
    tooltip: "Message Square 02",
  },
  messageTextCircle01: {
    category: "editors",
    icon: MessageTextCircle01,
    tooltip: "Message Text Circle 01",
  },
  messageTextCircle02: {
    category: "editors",
    icon: MessageTextCircle02,
    tooltip: "Message Text Circle 02",
  },
  messageTextSquare01: {
    category: "editors",
    icon: MessageTextSquare01,
    tooltip: "Message Text Square 01",
  },
  messageTextSquare02: {
    category: "editors",
    icon: MessageTextSquare02,
    tooltip: "Message Text Square 02",
  },
  messageXCircle: {
    category: "editors",
    icon: MessageXCircle,
    tooltip: "Message X Circle",
  },
  messageXSquare: {
    category: "editors",
    icon: MessageXSquare,
    tooltip: "Message X Square",
  },
  microphone: {
    category: "editors",
    icon: Microphone01,
  ...
  minimize01: { category: "general", icon: Minimize01, tooltip: "Minimize" },
  ...
  phoneCall01: {
    category: "editors",
    icon: PhoneCall01,
    tooltip: "Phone Call 01",
  },
  phoneCall02: {
    category: "editors",
    icon: PhoneCall02,
    tooltip: "Phone Call 02",
  },
  phoneIncoming01: {
    category: "editors",
    icon: PhoneIncoming01,
    tooltip: "Phone Incoming 01",
  },
  phoneIncoming02: {
    category: "editors",
    icon: PhoneIncoming02,
    tooltip: "Phone Incoming 02",
  },
  phoneOutgoing01: {
    category: "editors",
    icon: PhoneOutgoing01,
    tooltip: "Phone Outgoing 01",
  },
  phoneOutgoing02: {
    category: "editors",
    icon: PhoneOutgoing02,
    tooltip: "Phone Outgoing 02",
  },
  ...
  presentationChart01: {
    ...
    tooltip: "Presentation Chart 01",
  },
  presentationChart02: {
    category: "editors",
    icon: PresentationChart02,
    tooltip: "Presentation Chart 02",
  },
  presentationChart03: {
    category: "editors",
    icon: PresentationChart03,
    tooltip: "Presentation Chart 03",
  },
  ...
  refreshCcw01: {
    category: "editors",
    icon: RefreshCcw01,
    tooltip: "Refresh Ccw 01",
  },
  refreshCcw02: {
    category: "editors",
    icon: RefreshCcw02,
    tooltip: "Refresh Ccw 02",
  },
  refreshCcw03: {
    category: "editors",
    icon: RefreshCcw03,
    tooltip: "Refresh Ccw 03",
  },
  refreshCcw04: {
    category: "editors",
    icon: RefreshCcw04,
    tooltip: "Refresh Ccw 04",
  },
  refreshCcw05: {
    category: "editors",
    icon: RefreshCcw05,
    tooltip: "Refresh Ccw 05",
  },
  refreshCw01: {
    category: "editors",
    icon: RefreshCw01,
    tooltip: "Refresh Cw 01",
  },
  ...
  reverseLeft: {
    category: "editors",
    icon: ReverseLeft,
    tooltip: "Reverse Left",
  },
  reverseRight: {
    category: "editors",
    icon: ReverseRight,
    tooltip: "Reverse Right",
  },
  ...
  search: { category: "editors", icon: SearchRefraction, tooltip: "Search" },
  ...
  slashCircle01: {
    category: "editors",
    icon: SlashCircle01,
    tooltip: "Slash Circle 01",
  },
  slashCircle02: {
    category: "editors",
    icon: SlashCircle02,
    tooltip: "Slash Circle 02",
  },
  slashDivider: {
    category: "editors",
    icon: SlashDivider,
    tooltip: "Slash Divider",
  },
  slashOctagon: {
    category: "editors",
    icon: SlashOctagon,
    tooltip: "Slash Octagon",
  },
  sliders: { category: "editors", icon: Sliders04, tooltip: "Sliders" },
  slidersHorizontal: {
    category: "editors",
    icon: SlidersHorizontalIcon,
    tooltip: "Sliders Horizontal",
  },
  smile: { category: "editors", icon: SmileIcon, tooltip: "Smile" },
  socialmedia: { category: "editors", icon: Camera01, tooltip: "Social Media" },
  spacing: { category: "editors", icon: ParagraphSpacing, tooltip: "Spacing" },
  sparkles: { category: "editors", icon: Sparkles, tooltip: "Sparkles" },
  speedometer01: {
    category: "editors",
    icon: Speedometer01,
    tooltip: "Speedometer 01",
  },
  speedometer02: {
    category: "editors",
    icon: Speedometer02,
    tooltip: "Speedometer 02",
  },
  speedometer03: {
    category: "editors",
    icon: Speedometer03,
    tooltip: "Speedometer 03",
  },
  ...
  squarePlus: {
    category: "editors",
    icon: PlusSquare,
    tooltip: "Basic Elements",
  },
  squareSigma: {
    category: "editors",
    icon: SquareSigma,
    tooltip: "Square Sigma",
  },
  squaresPlus: {
    category: "editors",
    icon: SquarePlus,
  ...
  switchHorizontal01: {
    ...
    tooltip: "Switch Horizontal 01",
  },
  switchHorizontal02: {
    category: "editors",
    icon: SwitchHorizontal02,
    tooltip: "Switch Horizontal 02",
  },
  switchVertical01: {
    category: "editors",
    icon: SwitchVertical01,
    tooltip: "Switch Vertical 01",
  },
  switchVertical02: {
    category: "editors",
    icon: SwitchVertical02,
    tooltip: "Switch Vertical 02",
  },
  ...
  userCheck01: {
    category: "editors",
    icon: UserCheck01,
    tooltip: "User Check 01",
  },
  userCheck02: {
    category: "editors",
    icon: UserCheck02,
    tooltip: "User Check 02",
  },
  userCircle: { category: "editors", icon: UserCircle, tooltip: "User Circle" },
  userDown01: {
    category: "editors",
    icon: UserDown01,
    tooltip: "User Down 01",
  },
  userDown02: {
    category: "editors",
    icon: UserDown02,
    tooltip: "User Down 02",
  },
  userEdit: { category: "editors", icon: UserEdit, tooltip: "User Edit" },
  userLeft01: {
    category: "editors",
    icon: UserLeft01,
    tooltip: "User Left 01",
  },
  userLeft02: {
    category: "editors",
    icon: UserLeft02,
    tooltip: "User Left 02",
  },
  userMinus01: {
    category: "editors",
    icon: UserMinus01,
    tooltip: "User Minus 01",
  },
  userMinus02: {
    category: "editors",
    icon: UserMinus02,
    tooltip: "User Minus 02",
  },
  userPlus01: {
    category: "editors",
    icon: UserPlus01,
    tooltip: "User Plus 01",
  },
  userPlus02: {
    category: "editors",
    icon: UserPlus02,
    tooltip: "User Plus 02",
  },
  userRight01: {
    category: "editors",
    icon: UserRight01,
    tooltip: "User Right 01",
  },
  userRight02: {
    category: "editors",
    icon: UserRight02,
    tooltip: "User Right 02",
  },
  ...
  // Add these to the iconMap object:
...
export const getIconsByCategory = (category: IconCategory) => {
  return Object.entries(iconMap)
    .filter(([, { category: iconCategory }]) => iconCategory === category)
    .map(([key]) => key)
}

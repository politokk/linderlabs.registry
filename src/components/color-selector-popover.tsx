...
import { ColorSelectorTab, usePreferencesStore } from "@/lib/preferences-store";
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="size-auto gap-0 overflow-hidden p-0" align="end">
        <Tabs defaultValue={colorSelectorTab} onValueChange={handleTabChange} className="gap-0">
